...
android {
    namespace = "com.kdab.xr_multiview_model_viewer"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.xr_multiview_model_viewer"
        minSdk = 32
        targetSdk = 32
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/xr_multiview_model_viewer")
    into("src/main/shaders/examples/xr_multiview_model_viewer")
}
