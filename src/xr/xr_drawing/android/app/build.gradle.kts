...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.xr_drawing"
        minSdk = 32
        targetSdk = 32
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../../assets/shaders/xr_drawing")
    into("src/main/shaders/xr_drawing")
}
...
tasks.named("preBuild") {
    dependsOn("copyShaders", "copyFonts")
}
